...
class _MainPageState extends State<MainPage> {
  ...
  Widget _controlBT() {
    return SwitchListTile(
      ...
      title: Text(
        _bluetoothState ? "Turn on Bluetooth" : "Turn off Bluetooth",
      ),
    );
  }
  ...
  Widget _infoDevice() {
    return ListTile(
      ...
      title: Text("Connected with : ${_deviceConnected?.name ?? "Nope"}"),
  ...
  Widget _inputSerial() {
    return ListTile(
      ...
      title: Padding(
        ...
        child: Text(
          "The number of pressing button: (x$times)",
  ...
  Widget _buttons() {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Control the LED', style: TextStyle(fontSize: 18.0)),
